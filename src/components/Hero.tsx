    ...
    return (
        <main className="flex items-center flex-col justify-between bg-[url('/src/assets/bg.svg')] bg-cover text-sm text-gray-800 max-md:px-4 text-center h-[785px]">
            ...
            <div className="flex flex-col items-center justify-center w-full">
                ...
                <p className="text-base mt-6 text-slate-600">Create something amazing with one simple message.</p>
                <div className="max-w-xl w-full bg-orange-50 border border-slate-300 rounded-xl overflow-hidden mt-4">
                    ...
                    <div className="flex items-center justify-between pb-3 px-3">
                        ...
                        <button className="flex items-center justify-center p-1 rounded size-6 bg-orange-500" aria-label="Send" type="button">
